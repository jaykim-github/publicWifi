...
//	 * @param x_SWIFI_WRDOFC
//	 * @param x_SWIFI_MAIN_NM
//	 * @param x_SWIFI_ADRES1
//	 * @param x_SWIFI_ADRES2
//	 * @param x_SWIFI_INSTL_FLOOR
//	 * @param x_SWIFI_INSTL_TY
//	 * @param x_SWIFI_INSTL_MBY
//	 * @param x_SWIFI_SVC_SE
//	 * @param x_SWIFI_CMCWR
//	 * @param x_SWIFI_CNSTC_YEAR
//	 * @param x_SWIFI_INOUT_DOOR
//	 * @param x_SWIFI_REMARS3
//	 * @param lAT
//	 * @param lNT
//	 * @param wORK_DTTM
//	 * @param dISTANCE
//	 */
//	public WifiInfo(String x_SWIFI_MGR_NO, String x_SWIFI_WRDOFC, String x_SWIFI_MAIN_NM, String x_SWIFI_ADRES1,
...
//			String x_SWIFI_REMARS3, Double lAT, Double lNT, String wORK_DTTM, Double dISTANCE) {
//		//super();
